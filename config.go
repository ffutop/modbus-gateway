...
func LoadConfig() (*Config, error) {
	...
	pflag.DurationP("timeout", "W", viper.GetDuration("timeout"), "Response wait time in milliseconds.")
	pflag.DurationP("rqst_pause", "R", viper.GetDuration("rqst_pause"), "Pause between requests in milliseconds.")
